...
const questions = [
    {
        title : 'How many letters are there in the English alphabet?',
        options : [
            '20',
            '21',
            '26',
    ...
    {
        title : 'Giddha is the folk dance of?',
        options : [
            'Punjab',
            'Maharasthra',
            'Gujrat',
    ...
    {
        title : 'India lies in which continent?',
        options : [
            'Africa',
            'Asia',
            'Europe',
    ...
    {
        title : 'Which animal has hump on its back?',
        options : [
            'Camel',
            'Zebra',
            'Tiger',
...
function Decrement() {
  if (document.getElementById) {
    ...
    if (mins < 0) {
      //alert('time up');
      if(!alert("time up")) document.location = 'third.html';
      minutes.value = 0;
      seconds.value = 0;
    }
...
function init() {
    document.body.innerHTML = `
        <h1 class="quiz-heading">Quiz Round 2</h1>
        <div class="app-body">
